...
// Resolve each inventory path to the DeviceType supplied by AllowableValues,
// including parent-chassis qualification when needed. Compare complete
// selectors to avoid substring collisions.
